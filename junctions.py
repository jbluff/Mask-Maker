...
def junction(params):
    ...
    if params['junction_type'] == 'dolan':
        ...
        plgs = [plgs, bridge, finger, needle] 
        ...
        plgs = [plgs,finger_funnel, needle_funnel]
        ...
        plgs = [plgs, inner_trace_fs,inner_trace_ns]
        ...
        plgs = [plgs, outer_funnel_fs, outer_funnel_ns]
